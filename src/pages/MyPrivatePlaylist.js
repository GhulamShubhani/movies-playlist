    ...
    const getAllData = async () => {
      try {
        const { data } = await axios.get(
            "https://smoggy-necklace-yak.cyclic.app/playlist/getallprivateplaylist",config
          // "http://192.168.1.6:8000/playlist/getallprivateplaylist",config
        );
...
export default MyPrivatePlaylist